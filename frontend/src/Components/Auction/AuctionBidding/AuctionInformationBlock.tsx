import {
  ...
  interface AuctionInformationBlockProps {
    auctionID: string;
  }
...
interface AuctionProps {
  ...
  export default function AuctionInformationDashboard({ auctionID}: AuctionInformationBlockProps) {
      ...
      useEffect(() => {
        ...
        const itemURL =
          `https://garckgt6p0.execute-api.us-east-1.amazonaws.com/Stage/auctions/${auction.itemId}`;
